...
public class ComoMeProtegerActivity6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_como_me_proteger6);


        Button btn_comomeproteger = (Button) findViewById(R.id.btnComomeproteger5);
