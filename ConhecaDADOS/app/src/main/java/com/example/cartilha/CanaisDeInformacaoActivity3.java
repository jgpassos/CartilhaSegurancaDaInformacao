...
public class CanaisDeInformacaoActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonProxPaginaCanaisDeInformacao3 =
                (Button) findViewById(R.id.buttonProxPaginaCanaisDeInformacao3);
        ...
        buttonProxPaginaCanaisDeInformacao3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), CanaisDeInformacaoActivity4.class);
