...
public class CartilhaActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnProximaPag = (Button) findViewById(R.id.buttonProxPaginaProx);
        Button btnAnterior = (Button) findViewById(R.id.buttonAnterior2);
        ...
        btnProximaPag.setOnClickListener(new View.OnClickListener() {
            @Override
