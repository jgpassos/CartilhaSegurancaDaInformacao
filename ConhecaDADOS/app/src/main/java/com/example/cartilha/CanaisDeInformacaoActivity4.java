...
public class CanaisDeInformacaoActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonProxPaginaCanaisDeInformacao4 =
                (Button) findViewById(R.id.buttonProxPaginaCanaisDeInformacao4);
        ...
        buttonProxPaginaCanaisDeInformacao4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), CanaisDeInformacaoActivity5.class);
        ...
        anterior.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), CanaisDeInformacaoActivity3.class);
                startActivity(intent);
            }
        });
