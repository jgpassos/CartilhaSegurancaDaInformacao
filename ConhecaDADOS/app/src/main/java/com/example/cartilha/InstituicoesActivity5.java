...
public class InstituicoesActivity5 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_instituicoes5);

        Button btn_ilpis = (Button) findViewById(R.id.btn_ilpis5);
