...
public class LeisEDireitosActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leis_edireitos5);

        Button buttonProxPagina10 = (Button) findViewById(R.id.buttonProxPagina10);
        ...
        buttonProxPagina10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), LeisEDireitosActivity6.class);
