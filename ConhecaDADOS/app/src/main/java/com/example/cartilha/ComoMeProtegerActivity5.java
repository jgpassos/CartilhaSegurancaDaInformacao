...
public class ComoMeProtegerActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_como_me_proteger5);

        Button btn_comomeproteger = (Button) findViewById(R.id.btnComomeproteger4);
