...
public class CanaisDeInformacaoActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonProxPaginaCanaisDeInformacao2 =
                (Button) findViewById(R.id.buttonProxPaginaCanaisDeInformacao2);
        ...
        buttonProxPaginaCanaisDeInformacao2.setOnClickListener(new View.OnClickListener() {
            @Override
