...
public class PerigosNaInternetActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_perigos_na_internet5);

        Button btn_perigosnainternet = (Button) findViewById(R.id.btn_PerigosNaInternet5);
