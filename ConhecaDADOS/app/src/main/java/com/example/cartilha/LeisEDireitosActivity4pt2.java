...
public class LeisEDireitosActivity4pt2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leis_edireitos_activity4pt2);

        Button buttonProxPagina9 = (Button) findViewById(R.id.buttonProxPagina9pt2);
