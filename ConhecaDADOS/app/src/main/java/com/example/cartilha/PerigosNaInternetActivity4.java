...
public class PerigosNaInternetActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_perigos_na_internet4);

        Button btn_perigosnainternet = (Button) findViewById(R.id.btn_PerigosNaInternet4);
        ...
        btnLer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String text3 = textView2.getText().toString();
