...
public class LeisEDireitosActivity7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonProxPagina12 = (Button) findViewById(R.id.buttonProxPagina12);
        ...
        buttonProxPagina12.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), LeisEDireitosActivity8.class);
