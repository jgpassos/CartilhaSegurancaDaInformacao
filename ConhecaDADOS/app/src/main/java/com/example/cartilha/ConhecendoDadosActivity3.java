...
public class ConhecendoDadosActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_conhecendo_dados3);

        Button buttonProxPagina4 = (Button) findViewById(R.id.buttonProxPagina4);
        ...
        buttonProxPagina4.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        anterior.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), ConhecendoDadosActivity2Pt2.class);
                startActivity(intent);
            }
        });
